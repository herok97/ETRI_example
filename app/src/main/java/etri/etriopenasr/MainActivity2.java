...
//import etri.etriopenasr.CaptionCreator;
...
////                            String response = sendDataAndGetResult(speechData, endIndex-startingIndex);
////                            String response = sendDataAndGetResult(Arrays.copyOfRange(speechData, 2 * startingIndex, 16000 * 20 * 2), endIndex-startingIndex);
